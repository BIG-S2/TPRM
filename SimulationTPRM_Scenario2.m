%This code runs Scenario 2 Section 3.1 described in the paper:
...
for i=1:N
    if Y(i,1)==0
        TI(:,:,:,i)=double(A)+30*auxball+cc*randn(64,64,50);
    else
...
save(strcat('Results_Scenario2_R',num2str(R),'_RR',num2str(RR),'.mat'))
